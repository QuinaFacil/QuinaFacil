-- ==========================================
-- MIGRATION: ADVANCED WINNER MATCH LOGIC (QUADRA & QUINA)
-- ==========================================

-- 1. Add matches column to winners
...
BEGIN
  ...
  -- Default distribution: 70% for Quina winners, 30% for Quadra winners
