...
import { Save, User, Mail, Phone, Wallet, Loader2 } from 'lucide-react';
...
export default function VendedorPerfilPage() {
  ...
  const handleUpdate = () => {
    // Manual form collection because we can't use <form>
  ...
  return (
    <>
      ...
      <Stack id="profile-form-container">
        <Grid cols={12} gap={6} align="start">
          ...
          <Box padding={6} bg="glass" border="glass" className="col-span-12 lg:col-span-4 h-full">
            <Stack gap={6} align="center" className="md:items-start">
              <Text variant="sub" color="primary">Foto de Perfil</Text>
              ...
              <Stack gap={1} align="center" className="w-full md:items-start">
                ...
                <Text variant="sub" color="primary">
                  Vendedor Parceiro
                </Text>
              </Stack>
          ...
          <Box padding={6} bg="glass" border="glass" className="col-span-12 lg:col-span-8">
            <Stack gap={8}>
              <Section num="01" title="Informações de Acesso e Contato">
                <Grid cols={2} gap={5}>
                  <InputField
                    label="Nome Completo"
                    name="name"
              ...
              <Section num="02" title="Financeiro e Recebimento">
                <InputField
                  label="Chave PIX"
                  name="pix_key"
