...
/**
 * Busca o perfil completo do vendedor logado
 */
...
export async function updateMyProfileAction(formData: FormData) {
  try {
    ...
    await AuditService.record({
      ...
      description: `Vendedor ${name} atualizou seus próprios dados de perfil.`
    });
    ...
    console.error("[ERROR] updateMyProfileAction:", message);
